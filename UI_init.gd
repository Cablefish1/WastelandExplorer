...
func _on_explore_suburban_wasteland_pressed():
	exploration_zone = "Suburban Wasteland"
	start_exploring()
	
	

func _on_explore_city_core_pressed():
	exploration_zone = "City Core"
	start_exploring()


func _on_explore_wildlands_pressed():
	exploration_zone = "Wildlands"
	start_exploring()

func start_exploring():
	storyteller.tell_player("You departed for the "+exploration_zone)
